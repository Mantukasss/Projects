...
const SYSTEM = [
  ...
  '{"lead": "...", "quote": "...", "context": "..."}',
  "",
  "lead — one line naming who said it and what it MEANS, ending with a colon.",
  '  Example: zont1x says Spirit still haven\'t done enough to call themselves the best team in the world:',
